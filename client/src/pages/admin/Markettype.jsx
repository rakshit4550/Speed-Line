...
import {
  ...
  clearSuccess,
  clearError,
} from "../../redux/markettype/markettypeSlice"; // Fixed import from markettypeSlice
import { fetchWhitelabels } from "../../redux/whitelabel/whitelabelSlice";
import { FaEdit, FaSave } from "react-icons/fa";
...
const ProofManagement = () => {
  ...
  // Get the content to display based on current state
  const displayContent = currentProof ? currentProof.content : error ? "Proof not found" : "";
