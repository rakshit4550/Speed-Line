    ...
    <>
      ...
      {previewOpen && currentWhitelabel && (
        <div className="fixed inset-0 flex items-center justify-center bg-transparent ">
          {/* <div className="bg-white p-8 rounded-2xl w-[50%] max-w-md shadow-xl">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6 flex justify-between items-center">
              <span>Whitelabel Preview</span>
              <div
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-2">
                  {currentWhitelabel.whitelabel_user}
                </div>

                <div className="font-medium text-gray-700">User:</div>
                <div className="col-span-2">{currentWhitelabel.user}</div>

                <div className="font-medium text-gray-700">Hexacode:</div>
                <div className="col-span-2 flex items-center">
                  {currentWhitelabel.hexacode}
                </div>
            ...
            <div className="flex justify-between mt-8">
              <button
                onClick={() => handleEdit(currentWhitelabel)}
